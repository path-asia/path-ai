...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF006AFF);
  late Color secondary = const Color(0xFF141516);
  late Color tertiary = const Color(0xFF0000FF);
  late Color alternate = const Color(0xFF98A2B3);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFF141516);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0xFF969696);
  ...
  late Color ratingBarColor = Color(0xFFFF9B26);
}
